...
export const Aside = () => (
  <div className="flex md:flex-col flex-col-reverse lg:items-center items-center md:space-y-12">
...
<Header
  meta={meta}
  headerImage={{url: '/epic-react/epic-react-screenshots@2x.png', alt: ''}}
...
<ContributorProfileCard
  ...
  image={{url: '/epic-react/taylor@2x.jpg'}}
>
...
- introduces the problem briefly in a video;
- gives you a coding exercise to do on your own;
- then walks through the solution in a video and answers questions that you might have come up with while doing the exercise.
...
<section className="bg-gradient-to-b from-blueGray-800 to-blueGray-900 sm:py-32 py-16 min-h-screen flex flex-col items-center justify-center px-5">
...
_A look at the stunning site for EpicReact.dev_
...
<Tweet tweetLink="kentcdodds/status/1236186943420952579" theme="dark" />
...
<figure className="grid sm:grid-cols-3 grid-cols-1 gap-16">

![telescope](/epic-react/telescope.png)

![satellite](/epic-react/satellite.png)

![rocket](/epic-react/rocket.png)
...
<Tweet tweetLink="jsehull/status/1311821906069209089" theme="dark" />
