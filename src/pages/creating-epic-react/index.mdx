export const meta = {
  title: `Case Study: Creating Epic React`,
  description: `Learn how Epic React came to be.`,
  contributors: [{name: 'Meg Cumby'}],
}

import {Header} from 'templates/case-study'

<Header
  meta={meta}
  headerImage={{url: '/epic-react/epic-react-launch@2x.png', alt: ''}}
  className="bg-blueGray-900 text-white sm:pt-56 pt-40 text-center px-5"
/>

<section className="bg-blueGray-900 sm:pb-32 pb-16 pt-8 min-h-screen flex flex-col items-center justify-center px-5">
<div className="prose prose-dark sm:prose-xl max-w-screen-md mx-auto text-white">
...
<section className="bg-blue-50 sm:py-32 py-16 min-h-screen flex flex-col items-center justify-center px-5">
<div className="prose prose-amber sm:prose-xl max-w-screen-md mx-auto text-blueGray-900">
