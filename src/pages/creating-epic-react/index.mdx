...
export const Aside = () => (
  <div className="flex md:flex-col flex-col-reverse lg:items-start items-center md:space-y-12">
    <CaseLink label="EpicReact.dev" url={meta.url} />
    <Client {...meta.client}>
      <blockquote className="pt-4 sm:text-lg italic">
        {`"I'm able to make the biggest impact for my time with SkillRecordings. I
        absolutely recommend it for anybody who wants to teach and reach a wide
        audience of people"`}
      </blockquote>
    </Client>
  </div>
