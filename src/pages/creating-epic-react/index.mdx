...
import {Section, Header, Client} from 'templates/case-study'
...
<Section containerClassName="bg-blueGray-900" className="text-white" aside={<Client image={{url: "/epic-react/kent@2x.png", alt: "Kent C. Dodds"}} name="Kent C. Dodds" ><blockquote className="pt-4 sm:text-lg sm:font-light">"I'm able to make the biggest impact for my time with SkillRecordings. I absolutely recommend it for anybody who wants to teach and reach a wide audience of people"</blockquote></Client>}>
