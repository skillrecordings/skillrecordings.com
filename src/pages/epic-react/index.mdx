export const meta = {
  ...
  client: {
    name: 'Kent C. Dodds',
    label: 'React expert, educator, client',
    image: {
  ...
  contributors: [{name: 'Meg Cumby'}],
  toc: [
    {
      url: '#how-it-all-began',
      label: 'How it all began',
    },
    {
      url: '#designing-the-content',
      label: 'Designing the content',
    },
    {
      url: '#producing-the-content-with-a-relentless-focus-on-quality',
      label: 'Producing the content with a relentless focus on quality',
    },
    {
      url: '#making-the-learning-experience-delightful-with-stunning-visuals',
      label: 'Making the learning experience delightful with stunning visuals',
    },
    {
      url: '#developing-custom-courseware-with-egghead-infrastructure',
      label: 'Developing custom courseware with egghead infrastructure',
    },
    {
      url: '#getting-people-excited-about-epic-react',
      label: 'Getting people excited about Epic React',
    },
    {
      url: '#working-together-in-a-trusted-relationship',
      label: 'Working together in a trusted relationship',
    },
    {
      url: '#-🥳-launching-epic-react',
      label: '🚀 🥳 Launching Epic React',
    },
  ],
  contributors: [
    {
...
export const Aside = () => (
  <div className="flex flex-col lg:items-center items-center md:space-y-12">
    <Client {...meta.client}>
      <blockquote className="pt-6 text-center sm:text-lg text-blueGray-100 font-serif italic">
        {`"I'm able to make the biggest impact for my time with Skill Recordings. I absolutely recommend it for anybody who wants to teach and reach a wide
        audience of people"`}
      </blockquote>
    </Client>
    <CaseLink label="EpicReact.dev" url={meta.url} />
    {meta.toc && (
      <div className="text-white w-full sm:pt-0 py-4">
        <h4 className="uppercase tracking-wider font-semibold pb-2 text-blueGray-300">
          Table of contents
        </h4>
        <ol className="list-inside">
          {meta.toc.map((link) => (
            <li className="py-2 list-decimal">
              <Link href={link.url}>
                <a className="cursor-pointer hover:underline lg:text-xl text-lg leading-tight">
                  {link.label}
                </a>
              </Link>
            </li>
...
export const Contributors = () => {
  return (
    <footer className="flex items-center justify-center bg-blueGray-900 text-white py-24">
      <div className="max-w-screen-md">
        {meta.contributors.map((person) => {
          return (
            <a href={person.link} className="flex items-center group">
              <Image
                ...
                height={64}
              />
              <div className="flex flex-col sm:pl-3 pl-2">
                <div>{'Written by'}</div>
                <div className="sm:text-xl text-lg font-medium group-hover:underline">
                  {person.name}
                </div>
              </div>
            </a>
...
<Header
  meta={meta}
  image={{url: '/epic-react/epic-react-screenshots@2x.png', alt: ''}}
  className="bg-gradient-to-b to-purple-600 from-indigo-600 text-white sm:pt-56 pt-40 text-center px-5"
/>

<Section containerClassName="bg-blueGray-900" className="text-white" aside={<Aside/>}>
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Designing the content">
...
"Then, when they see the solution, those questions are answered one by one. That helps with retention a great deal, rather than just being briefly exposed to the problem and just watching me solve it. **I want to make sure that when I'm teaching somebody something that they actually remember it.**”
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Producing the content with a relentless focus on quality">
...
<ContributorProfileCard rotate={"rotate-2"} contributors={[
{
name: "Zac Jones",
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Making the learning experience delightful with stunning visuals">

You can't help but be drawn in by the stunning visual work that's gone into [EpicReact.dev](https://epicreact.dev).

<div className="xl:-mx-16 lg:-mx-10 -mx-5">
  <Image
    src="/epic-react/screenshots@2x.png"
    alt="screenshots of EpicReact.dev site"
    width={2196}
    height={2971}
    quality={100}
  />
...
<ContributorProfileCard contributors={[{
  name: "Vojta Holik",
...
Vojta Holik worked his magic to present the workshop beautifully, inside and out, to make it easy to access and use. He's responsible for pretty much all of the UI/UX design work on the site and in the workshop itself, including all the delightful animations.

</ContributorProfileCard>

<div className="grid sm:grid-cols-2 grid-cols-1 xl:-mx-16 lg:-mx-10 sm:-mx-5 sm:gap-8 sm:pb-8">
<div>
...
<Tweet className="transform -rotate-3" tweetLink="kentcdodds/status/1236186943420952579" theme="dark" />
</div>
...
<ContributorProfileCard rotate={"rotate-0"} contributors={[
{
...
<div className="sm:-mx-10">
  <Image
    src="/epic-react/illustrations@2x.png"
    alt="some illustrations from EpicReact.dev"
    width={1167}
    height={1149}
    quality={100}
  />
...
_Examples of the 3D artwork by David Gil and Gustavo Henrique, with Art Direction by Maggie Appleton_

</Section>

<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Developing custom courseware with egghead infrastructure
">
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Getting people excited about Epic React" titleClassName="max-w-screen-md">
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="Working together in a trusted relationship" titleClassName="max-w-screen-md">
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white" title="🚀 🥳 Launching Epic React">
...
**After 18 months of planning and building and an absolutely massive amount of effort, [Epic React launched](http://epicreact.Dev) on September 29.**

<Tweet tweetLink="kentcdodds/status/1310990076029972480" theme="dark" />
...
<div className="grid sm:grid-cols-2 grid-cols-1 gap-5">
  <Tweet tweetLink="denvercoder/status/1311878063286816768" theme="dark" />
  <Tweet tweetLink="lizzSoup/status/1311403774041354241" theme="dark" />
  <Tweet tweetLink="PTolideh/status/1311507868303208449" theme="dark" />
  <Tweet tweetLink="dcgoodwin2112/status/1311467223043670022" theme="dark" />
</div>
