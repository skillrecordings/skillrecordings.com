        ...
        <ol className="list-inside">
          {meta.toc.map((link) => (
            <li className="py-1 list-decimal">
              <Link href={link.url}>
                <a className="cursor-pointer hover:underline font-medium lg:text-xl text-lg">
                  {link.label}
                </a>
              </Link>
            </li>
...
<Section containerClassName="bg-gradient-to-t from-blueGray-900 to-blueGray-800" className="text-white">
